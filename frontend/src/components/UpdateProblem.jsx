        ...
        try {
            ...
            const formData = {
                ...
                startCode: languages.map(lang => ({
                    language: lang,
                    initialCode: problem.startCode?.find(sc => sc.language === lang)?.initialCode || ''
                })),
                referenceSolution: languages.map(lang => ({
                    language: lang,
                    completeCode: problem.referenceSolution?.find(rs => rs.language === lang)?.completeCode || ''
                })),
            ...
            alert(error.response?.data?.message || 'Failed to fetch problem');
            navigate('/admin');
        }
    }, [id, reset, navigate]);
